...
DROP POLICY IF EXISTS "Donors can manage their donations" ON public.donations;
...
DROP POLICY IF EXISTS "Users can update their requests" ON public.requests;
...
INSERT INTO public.delivery_personnel (name, phone, status) VALUES 
('Rajesh Kumar', '+91 9876543210', 'available'),
('Amit Singh', '+91 9876543211', 'available'),
('Priya Sharma', '+91 9876543212', 'busy')
